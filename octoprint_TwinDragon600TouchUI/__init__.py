...
class TwinDragon600TouchUI(octoprint.plugin.StartupPlugin):
    ...
    def get_update_information(self):
        return dict(
            TwinDragon600TouchUI=dict(
                displayName="TwinDragon600TouchUI",
...
def __plugin_load__():
    ...
    __plugin_implementation__ = TwinDragon600TouchUI()
